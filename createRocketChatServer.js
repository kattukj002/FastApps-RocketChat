...
let rocketchatParameters = {
    stackName: "RolesTestingStack4",
    companyName: "companyKrispies",
    mongoURL: "mongodb://52.90.136.88:27017/companyKrispies",

    //accessKeyId:  "AKIAIEX77KYKIZEPSR6Q",
    //secretAccessKey: "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",

    accessKeyId: "AKIAJEHACKQXILMIBPXA",
    secretAccessKey: "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",

    hostedZone: "aboutus123.com",
    hubotScriptS3URL: "https://hubotsettings.s3.amazonaws.com/HubotScriptNEW.js",
    keyName: "OhioSandbox",
    securityGroup: "Production",
    templateURL: "https://s3.us-east-2.amazonaws.com/cf-templates-twbp7jwnrxtx-us-east-2/2018227U4l-RocketChatServerConfig2.json",
    apacheConfigURL: "https://apacheconfiguration.s3.amazonaws.com/rocketChat.conf",
    region: "us-east-2",
    companyDBHost: "chatbot-dev.cbtga4o6fi13.us-east-1.rds.amazonaws.com",
    companyDBUserName: "Lincoln",
    companyDBPassword: "lincolnlo",
    companyDBName: "ChatBotDevDb",
    botPassword: "asfsfoiroaefgf8onfdhuoq344q3t98a", //This value cannot be changed without a corresponding change to the Mongo database first!
    javaHostName: "54.173.178.139",
    javaPort: "8080",
    roleName: "RocketChatRole"
};
