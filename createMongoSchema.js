...
//mongoURL = url of the mongo database to connect to (EX: mongodb://1.2.3.4:27017/rocketchat)
...
let mongoURL = "mongodb://1.2.3.4:27017/rocketchatTemplate";
let companyName = "companyKrispies";
let copyFrom = "rocketchatTemplate";
let scdp = "chat";

let scdep = "http://1.2.3.4/simplesaml/saml2/idp/SSOService.php";
let scdisru = "http://1.2.3.4/simplesaml/saml2/idp/SingleLogoutService.php";
let hostedZone = "random.com";
